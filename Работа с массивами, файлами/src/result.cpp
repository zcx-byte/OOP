...
namespace result {
    ...
    // шаблонная функция для вычисления суммы квадратов разностей (sqrt|x| - x) для вектора
    template<typename T>
    ...
    // шаблонная функция для вычисления суммы квадратов разностей (sqrt|x| - x) для массива
    template<typename T>
